...
const save=()=>{try{localStorage.setItem('kazz-play-v1',JSON.stringify(saved))}catch{toast('端末に保存できません。管理リンクを控えてください')}};
...
document.addEventListener('click',async e=>{
 ...
 if(action==='mark'){await act('mark',{value:Number(el.dataset.value)});return}
